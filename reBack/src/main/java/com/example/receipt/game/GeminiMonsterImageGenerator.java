...
public class GeminiMonsterImageGenerator {
    ...
    static byte[] normalize(byte[] bytes) throws Exception {
        ...
        BufferedImage out=new BufferedImage(16,16,BufferedImage.TYPE_INT_RGB); Graphics2D g=out.createGraphics(); g.setColor(Color.WHITE); g.fillRect(0,0,16,16); double scale=Math.min(16d/source.getWidth(),16d/source.getHeight()); int w=(int)(source.getWidth()*scale),h=(int)(source.getHeight()*scale); g.drawImage(source,(16-w)/2,(16-h)/2,w,h,null); g.dispose();
